(function($){
    ...
    function paginationHandler(){
        ...
        soso.eq(iIndex).addClass("show").siblings().removeClass("show");
    ...
    function initEffects(dest,element){
        ...
        element.addClass('show').siblings().removeClass('show');
        element.addClass('page2-li').siblings().removeClass('page2-li');
        if(opts.pagination){
            paginationHandler();
        }
    }
